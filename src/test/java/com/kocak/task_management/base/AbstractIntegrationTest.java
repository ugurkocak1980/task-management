...
public abstract class AbstractIntegrationTest extends TestFactory {
    ...
    //we can @Autowire any bean that’s picked up by component scanning into our test

    //use the webEnvironment attribute of @SpringBootTest to configure our runtime environment
    //using WebEnvironment.MOCK here so that the container will operate in a mock servlet environment
    ...
    //application.properties contains the details to configure the persistence storage:
